...
const industries = ["ECN Forex Brokers", "Crypto Exchanges", "Social Trading Platforms", "Proprietary Trading Firms", "Options Trading Platforms"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Financial Broker Analyst for FX278. Focus on spreads, commissions, leverage limits, deposit/withdrawal methods, and regulatory licenses.
